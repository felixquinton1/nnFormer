...
class nnFormerTrainerV2_nnformer_livertumour(nnFormerTrainer):
    """
    ...
    def initialize_network(self):
        ...
        if self.load_pretrain_weight:
            checkpoint = torch.load("/home/felix/Bureau/weight/tumor_pretrain.model",
                                    map_location='cpu')  # acdc and tumor use the same pretrain weight
            ck = {}
